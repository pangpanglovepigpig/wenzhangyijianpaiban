...
首先，把目标范围缩小。正文继续解释具体做法和判断标准。这里补充完整的背景、实际限制和判断依据，帮助读者理解这一步的具体安排。这里补充完整的背景、实际限制和判断依据，帮助读者理解这一步的具体安排。
...
第1件事，是确定真实目标。后面继续解释具体判断。这里继续说明具体方法与判断依据，并交代为什么需要这样安排，帮助读者理解每个实际操作。这里继续说明具体方法与判断依据，并交代为什么需要这样安排，帮助读者理解每个实际操作。

第2件事，是完成一次验证。后面继续解释具体做法。`);
    const isolated = createBlocksFromText(`### 单独序号

第一件事，是先处理眼前的问题。后面继续解释具体做法。这里继续说明具体方法与判断依据，并交代为什么需要这样安排，帮助读者理解每个实际操作。这里继续说明具体方法与判断依据，并交代为什么需要这样安排，帮助读者理解每个实际操作。`);
